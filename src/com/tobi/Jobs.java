...
public class Jobs {
    ...
    public void createJobs(){
        ...
        jobLinkedList.push(new Job("Beggar",0,0,0));
        ...
        jobLinkedList.push(new Job("Child",0,0,0));
        jobLinkedList.push(new Job("Farmer",10,20,0));
        ...
        jobLinkedList.push(new Job("Innkeep",20,10,0));
        jobLinkedList.push(new Job("Lady",0,0,0));
        ...
        jobLinkedList.push(new Job("Prostitute",0,0,0));
